...
plugins:
  ...
  absolutepath:
    url: "http://www.butterfill.com/talk-slides/presenting_your_research/"
   cleanurls:
	...
	templateData:
		...
		site:
			...
			description: """
				Session for a postgraduate development series by s.butterfill@warwick.ac.uk
				"""

			# The website keywords (for SEO) separated by commas
			keywords: """
				presentation, handout, slides, powerpoint
				"""
